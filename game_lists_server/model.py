...
class Game(BaseModel):
    id = P.AutoField()
    date_last_updated = P.DateTimeField(null=True)
    # if date_last_updated is null then developers, franchises, genres for this game not exist
    name = P.TextField()
